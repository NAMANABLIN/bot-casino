...
NO_ACCOUNT = 'Сначала зарегистрируйтесь, напишите "Начать" ' \
             'в личные сообщения бота(без кавычек)'
WRONG_BET = f'Такой ставки не существует\n' \
            ...
            f'Так же вы можеть поставить на число (x36):\n' \
            f'От 0 до 36, писать нужно цифрами, но при \n' \
            f'ставке на 0 так же можно написать: {(", ".join(zero_bets))}\n'
HELP = 'Команды вписывать без "" и <>\n' \
       ...
       'Перевести другому пользователю - "Перевести ' \
       '<кому(подходит ссылка или упоминание в чате)> <сколько>"\n' \
       'Сыграть в рулетку, после прописание команды, ' \
       'выпадает число от 0 до 36. Можно ставить на чётность(x2),\n' \
       'нечётность(x2) числа, или само число(x36). ' \
       'Если вы выигрывайте, то получаете умноженную ставку,\n' \
